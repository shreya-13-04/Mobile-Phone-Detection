...
for frame_file in frame_files:
    ...
    # Log timings and detection status
    print(f"Frame: {frame_file}")
    print(f"  Phone Detected: {'Yes' if frame_phone_detected else 'No'}")
...
'''
1)we did the time analysis for the code and tried to improve it
2)continuous extraction of the frames from the survillence camera
3)we improved it for some seconds
'''